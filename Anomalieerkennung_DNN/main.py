...
# train cnn
cnn_model, cnn_history = train_cnn(epoch, batch_size, X_train, y_train, X_val, y_val)
# train mini cnn
mini_cnn_model, mini_cnn_history = train_minicnn(epoch, batch_size, X_train, y_train, X_val, y_val)
