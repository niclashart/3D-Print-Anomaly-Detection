...
joblib.dump(one_hot_encoder, "./Anomalieerkennung_DNN/Modell/seitlich/one_hot_encoder.joblib")
...
cnn_model.save("./Anomalieerkennung_DNN/Modell/seitlich/cnn_model.h5")
# Mini-CNN Trainieren
mini_cnn_model, mini_cnn_history = train_minicnn(epoch, batch_size, image_size, num_classes, X_train, y_train, X_val, y_val)
mini_cnn_model.save("./Anomalieerkennung_DNN/Modell/seitlich/mini_cnn_model.h5")
